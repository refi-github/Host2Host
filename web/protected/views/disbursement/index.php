    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?= Html::beginForm(['disbursement/index'], 'get', ['id' => 'application-search-form']) ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?= Html::tag('label', 'Tanggal Disbursement', ['for' => 'disbursement_date_from']) ?>
                                        <div class="input-group">
                                            <?= Html::input('text', 'disbursement_date_from', Yii::$app->request->get('disbursement_date_from'), [
                                                'class' => 'form-control datepicker', 
                                                'id' => 'disbursement_date_from',
                                                'placeholder' => 'Dari',
                                                'autocomplete' => 'off',
                                            ]) ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?= Html::tag('label', '&nbsp;', ['for' => 'disbursement_date_until']) ?>
                                        <div class="input-group">
                                            <?= Html::input('text', 'disbursement_date_until', Yii::$app->request->get('disbursement_date_until'), [
                                                'class' => 'form-control datepicker', 
                                                'id' => 'disbursement_date_until',
                                                'placeholder' => 'Sampai',
                                                'autocomplete' => 'off',
                                            ]) ?>
                                            <div class="input-group-append">
